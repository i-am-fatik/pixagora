        ...
        <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="flex h-10 items-center gap-3 rounded-md px-4 text-sm font-semibold text-white transition hover:opacity-90"
                style={{ backgroundColor: "#1ebd39" }}
              >
                <span className="flex-1 text-left">Podpořit na Startovači</span>
                <span className="flex w-[6.5rem] shrink-0 items-center gap-1.5">
